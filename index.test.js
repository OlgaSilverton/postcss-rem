...
describe('Unit form', () => {
    ...
    it('Fractional values', () => run(
        '.fractional { font-size: 2.4rem; }',
        '.fractional { font-size: 0.15rem; }',
        {
            useUnits: true
        }
    ));
    ...
    it('Pixel fallback', () => run(
        '.fallback { font-size: 24rem; margin: 10px 24rem; }',
        '.fallback { font-size: 24px; font-size: 1.5rem; margin: 10px 24px; margin: 10px 1.5rem; }',
        {
            fallback: true,
            useUnits: true
        }
    ...
    it('Convert to pixel', () => run(
        '.convert { font-size: 1.5rem; margin: 0.625rem 1.5rem; }',
        '.convert { font-size: 24px; margin: 10px 24px; }',
        {
            convert: 'px',
            useUnits: true
